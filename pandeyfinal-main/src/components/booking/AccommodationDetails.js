...
const accommodationTypes = [
  { value: '2days', label: '2 Day 1 Night', originalPrice: 'Rs. 12,999', discountedPrice: 'Rs. 6,999' },
  { value: '3days', label: '3 Day 2 Night', originalPrice: 'Rs. 21,500', discountedPrice: 'Rs. 11,999' },
];
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setSelectedPackage({ title: type.label, price:(type.discountedPrice.replace(/[^0-9-,]+/g,"")) });
                  }}
